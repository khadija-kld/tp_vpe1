...
class MainGame:
    ...
    def run(self):
        ...
        max_cube_y = -float('inf')  # Initialize with the smallest possible value
        for cube in self.cubes:
            if cube.position[1] > max_cube_y:
                max_cube_y = cube.position[1]
            ...
            for event in events:
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_SPACE:
                        ...
                        if self.cubes[0].zoom < 3 :
                            self.camera_vertical_position += 860
                            self.jump_sound.play()
            
                            ground += 2
                            if ground > max_cube_y :
                                self.camera_vertical_position = 400
                                ground = -2
